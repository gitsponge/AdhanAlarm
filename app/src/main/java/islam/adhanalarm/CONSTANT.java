...
public class CONSTANT {
	...
	public static final String ACTION_UPDATE_PRAYER_TIME = "islam.adhanalarm.action.UPDATE_PRAYER_TIME";
	public static final String ACTION_NOTIFY_PRAYER_TIME = "islam.adhanalarm.action.NOTIFY_PRAYER_TIME";
	public static final String ACTION_NOTIFICATION_CLICKED = "islam.adhanalarm.action.NOTIFICATION_CLICKED";
	public static final String ACTION_NOTIFICATION_DELETED = "islam.adhanalarm.action.NOTIFICATION_DELETED";
	public static final String ACTION_NOTIFICATION_STOPPED = "islam.adhanalarm.action.NOTIFICATION_STOPPED";
	...
	public static final short NOTIFICATION_NONE = 0, NOTIFICATION_DEFAULT = 1, NOTIFICATION_BEEP = 2, NOTIFICATION_PLAY = 3; // Notification Methods
